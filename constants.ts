...
export const TEST_VERSIONS = {
  ...
  2: { 
    name: "하나님의 일 속의 나", 
    description: "사명과 사역을 수행할 때 나타나는 나의 능력과 방식",
    color: "purple"
  },
  3: { 
    name: "위기 속의 나", 
...
export const QUESTIONS_V1: Question[] = [
  {
    text: "교회 공동체에서 갈등이 생겼을 때, 다윗처럼 나는",
    answers: [
  ...
  {
    text: "공동체에서 의견 충돌이 있을 때, 솔로몬처럼 나는",
    answers: [
  ...
  {
    text: "셀 모임이나 구역 예배를 인도할 때, 느헤미야처럼 나는",
    answers: [
  ...
  {
    text: "형제자매가 어려움에 처했을 때, 욥의 친구들과 달리 나는",
    answers: [
...
export const QUESTIONS_V2: Question[] = [
  {
    text: "하나님께서 새로운 사명을 주셨을 때, 노아처럼 나는",
    answers: [
  ...
  {
    text: "팀 사역에서 문제가 생겼을 때, 솔로몬처럼 나는",
    answers: [
...
export const QUESTIONS_V3: Question[] = [
  ...
  {
    text: "예상치 못한 어려움을 만났을 때, 기드온처럼 나는",
    answers: [
