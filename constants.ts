...
export const QUESTIONS: Question[] = [
  {
    ...
    answers: [
      { text: "즉시 샤워하고 나간다 🏃‍♂️", type: 'E' },
      { text: "'내일 만나자'고 답장을 보낸다 🏠", type: 'I' },
    ],
  },
  {
    text: "넷플릭스에서 새 드라마를 고를 때",
    answers: [
      { text: "평점과 리뷰를 먼저 확인한다 📊", type: 'S' },
      { text: "포스터 보고 감으로 고른다 🎲", type: 'N' },
    ],
  },
  {
    text: "친구가 '연애 상담 좀...'이라고 톡을 보냈다.",
    answers: [
      { text: "'팩트 정리해봐' 하고 논리적으로 분석해준다 🔍", type: 'T' },
      { text: "'속상했겠다ㅠㅠ' 하며 공감부터 한다 🫂", type: 'F' },
    ],
  },
  {
    text: "부산 여행을 3일 앞두고",
    answers: [
      { text: "이미 코스별 맛집까지 다 찾아놨다 📋", type: 'J' },
      { text: "숙박만 예약하고 나머지는 현지에서 결정 🛤️", type: 'P' },
    ],
  },
  {
    text: "회사 회식에서 상사가 '한마디씩 해봐~'라고 했다.",
    answers: [
      { text: "자연스럽게 재미있는 얘기를 한다 🎤", type: 'E' },
      { text: "간단히 '감사합니다'로 끝낸다 😅", type: 'I' },
    ],
  },
  {
    text: "새로 이사온 집에 가전제품을 살 때",
    answers: [
      { text: "용량, 전력, 리뷰를 꼼꼼히 비교한다 📏", type: 'S' },
      { text: "디자인이 예쁘고 직감적으로 끌리는 걸 산다 ✨", type: 'N' },
    ],
  },
  {
    text: "후배가 업무 실수로 우울해하고 있다.",
    answers: [
      { text: "'다음엔 이렇게 해보자'며 해결방안을 제시한다 💡", type: 'T' },
      { text: "'괜찮아, 누구나 실수해'라며 위로한다 🤗", type: 'F' },
    ],
  },
  {
    text: "주말 아침, 일어나자마자 드는 생각",
    answers: [
      { text: "'오늘 뭐 해야 하지?' 할 일을 체크한다 ✅", type: 'J' },
      { text: "'오늘은 뭐 하고 놀까?' 기분에 맡긴다 🌈", type: 'P' },
    ],
  },
  {
    text: "카페에서 혼자 있을 때",
    answers: [
      { text: "주변 사람들 구경하며 상상의 나래를 펼친다 👀", type: 'E' },
      { text: "폰 보거나 책 읽으며 내 세계에 빠진다 📱", type: 'I' },
    ],
  },
  {
    text: "유튜브 알고리즘이 추천한 영상",
    answers: [
      { text: "'실제 후기', '비교 리뷰' 같은 팩트 위주 영상 📈", type: 'S' },
      { text: "'만약에...', '상상해봤는데' 같은 아이디어 영상 💭", type: 'N' },
    ],
  },
  {
    text: "친구가 '이별했어...'라고 톡을 보냈다.",
    answers: [
      { text: "'왜? 무슨 일 있었어?' 상황부터 파악한다 🕵️", type: 'T' },
      { text: "'어떡해ㅠㅠ 괜찮아?' 감정부터 보듬는다 💝", type: 'F' },
    ],
  },
  {
    text: "내 방 상태를 가장 잘 표현하면",
    answers: [
      { text: "침대 정리, 책상 깔끔, 물건들 제자리 🏠", type: 'J' },
      { text: "편한 게 최고, 쓰던 물건은 그대로 두기 🛋️", type: 'P' },
    ],
  },
];
