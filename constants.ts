...
export const QUESTIONS: Question[] = [
  {
    text: "주말 저녁, 당신은 어떻게 시간을 보내나요?",
    answers: [
      { text: "친구들과 함께 활기찬 모임에 참여한다.", type: 'E' },
      { text: "집에서 조용히 책을 읽거나 영화를 본다.", type: 'I' },
    ],
  },
  {
    text: "새로운 프로젝트를 시작할 때, 당신의 접근 방식은?",
    answers: [
      { text: "구체적인 사실과 경험을 바탕으로 계획을 세운다.", type: 'S' },
      { text: "미래의 가능성과 전체적인 그림을 먼저 그린다.", type: 'N' },
    ],
  },
  {
    text: "친구가 고민을 털어놓을 때, 당신의 반응은?",
    answers: [
      { text: "객관적인 분석으로 해결책을 찾아주려 한다.", type: 'T' },
      { text: "따뜻한 공감과 위로의 말을 건넨다.", type: 'F' },
    ],
  },
  {
    text: "여행을 계획할 때, 당신은?",
    answers: [
      { text: "출발 전 모든 일정을 미리 짜놓아야 마음이 편하다.", type: 'J' },
      { text: "상황에 따라 유연하게, 즉흥적으로 즐기는 편이다.", type: 'P' },
    ],
  },
  {
    text: "처음 만난 사람들과의 대화에서 당신은?",
    answers: [
      { text: "먼저 말을 걸며 대화를 이끌어가는 편이다.", type: 'E' },
      { text: "상대방의 이야기를 주로 들어주는 편이다.", type: 'I' },
    ],
  },
  {
    text: "문제를 해결할 때 더 중요하게 생각하는 것은?",
    answers: [
      { text: "현재 활용할 수 있는 실용적인 방법.", type: 'S' },
      { text: "새롭고 독창적인 아이디어나 접근법.", type: 'N' },
    ],
  },
  {
    text: "결정을 내려야 할 때, 무엇에 더 의존하나요?",
    answers: [
      { text: "논리적인 원칙과 사실 관계.", type: 'T' },
      { text: "나와 다른 사람들의 감정적인 영향.", type: 'F' },
    ],
  },
  {
    text: "당신의 책상이나 방은 보통 어떤 상태인가요?",
    answers: [
      { text: "항상 깔끔하게 정리정돈 되어 있다.", type: 'J' },
      { text: "자유롭고 편안한 상태, 때로는 어수선하다.", type: 'P' },
    ],
  },
  {
    text: "힘들고 지칠 때 에너지를 얻는 방법은?",
    answers: [
      { text: "사람들을 만나 이야기하며 에너지를 얻는다.", type: 'E' },
      { text: "혼자만의 시간을 가지며 재충전한다.", type: 'I' },
    ],
  },
  {
    text: "설명을 할 때 당신의 스타일은?",
    answers: [
      { text: "순서대로, 구체적이고 상세하게 설명한다.", type: 'S' },
      { text: "비유나 상징을 사용하여 핵심 의미를 전달한다.", type: 'N' },
    ],
  },
  {
    text: "다른 사람을 평가할 때, 더 중요한 기준은?",
    answers: [
      { text: "그 사람의 능력과 공정함.", type: 'T' },
      { text: "그 사람의 따뜻함과 배려심.", type: 'F' },
    ],
  },
  {
    text: "마감 기한이 있는 일을 할 때 당신은?",
    answers: [
      { text: "미리 계획을 세워 꾸준히 진행한다.", type: 'J' },
      { text: "마감 직전에 집중해서 끝내는 편이다.", type: 'P' },
    ],
  },
];
