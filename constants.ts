...
export const QUESTIONS: Question[] = [
  {
    text: "기도 모임에서 나는?",
    answers: [
      { text: "주로 나의 기도 주제에 대해 말하는 스타일이다.", type: 'E' },
      { text: "주로 다른 사람의 기도 주제를 들어주는 스타일이다.", type: 'I' },
    ],
  },
  {
    text: "한 성도가 모임 시간에 늦었다",
    answers: [
      { text: "사과하면 마음이 풀린다.", type: 'F' },
      { text: "늦게 된 이유에 대해 말하면 마음이 풀린다.", type: 'T' },
    ],
  },
  {
    text: "예배 동안의 아담과 이브를 떠올렸을 때 가장 먼저 드는 생각은?",
    answers: [
      { text: "그래도 왜 하나님의 말씀을 어기고...", type: 'T' },
      { text: "선악과는 무슨 맛이었을까? 어떻게 생겼을까?", type: 'N' },
    ],
  },
  {
    text: "기분이 안 좋은 일이 생겼다",
    answers: [
      { text: "진한 성도들을 만나서 수다 떨면서 푼다.", type: 'E' },
      { text: "혼자 잠에서 쉬면서 푼다.", type: 'I' },
    ],
  },
  {
    text: "이해와 공감 중 나는",
    answers: [
      { text: "이해가 안 가도 일단 공감할 수 있다.", type: 'F' },
      { text: "이해해야 공감할 수 있다.", type: 'T' },
    ],
  },
  {
    text: "나의 현금 스타일은",
    answers: [
      { text: "주일의 되기 며칠 전부터 미리 헌금을 준비해놓고 봉투에 넣어둔다.", type: 'J' },
      { text: "주일 당일날 지갑에서 꺼낸다.", type: 'P' },
    ],
  },
  {
    text: "전국을 떠올렸을 때 가장 먼저 드는 생각은?",
    answers: [
      { text: "예수님을 믿고 구원받으면 갈 수 있는 곳.", type: 'N' },
      { text: "전국은 어떤 모습일까? 문명 때문에 평화로울 거야", type: 'S' },
    ],
  },
  {
    text: "사람들과 있을 때 나는 보통",
    answers: [
      { text: "대화를 주도하는 스타일이다.", type: 'E' },
      { text: "조용히 있는 스타일이다.", type: 'I' },
    ],
  },
  {
    text: "한 성도가 자신의 기도가 응답받지 못한다며 슬퍼한다, 나의 반응은?",
    answers: [
      { text: "일단가 응답받게 될 거야, 조급해하지 말고 현재에 가다려봐.", type: 'F' },
      { text: "내가 얻지 기도를 안 에서 그래, 더 얻지 기도해봐!", type: 'T' },
    ],
  },
  {
    text: "친한 사람들과 여행을 가기로 했다",
    answers: [
      { text: "시간 단위, 본 단위별로 계획을 세세하게 짠다.", type: 'J' },
      { text: "대략적인 코스만 짜놓고 상황에 따라 유동적 있게 한다.", type: 'P' },
    ],
  },
  {
    text: "예배가 끝나고 몇몇 사람들과 밖에서 집심을 먹기로 했다, 저변에 간 식당이 짱엄하여 또 가려고 하는데",
    answers: [
      { text: "정성시간이라 저리가 없을 수도 있으니 진하해보고 가자.", type: 'T' },
      { text: "일단 가보고 자리가 없으면 곧제에 있는 다른 식당에 가자.", type: 'F' },
    ],
  },
  {
    text: "예배가 끝난 후 집에 갈 때, 오늘따라 컨디션이 좋다",
    answers: [
      { text: "항상 가던 길로 집에 간다.", type: 'S' },
      { text: "때론 가던 길이 지루해 오늘은 새로운 길로 가보자!", type: 'N' },
    ],
  },
];
